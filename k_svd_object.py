'''
#Code taken and modified from existing python implementation of ksvd by nel215, here:
...
#Modified version of the KSVD (Discrimintative K-SVD), that also does profiling for the datas.
class Approximate_D_KSVD(object):
    def __init__(self, n_components, max_iter=10, tol=1e-6,
                 transform_n_nonzero_coefs=None):
        """
        Parameters
